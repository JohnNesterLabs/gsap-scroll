...
// Easing functions for smooth scroll speed control
...
export default function DemoEasing() {
    ...
    // Easing control state
    const [easingType, setEasingType] = useState('easeInOut');
    const [easingIntensity, setEasingIntensity] = useState(1.0);
    ...
    const handleScroll = useCallback(() => {
        ...
        // Apply easing function to control scroll speed
        const easingFunction = easingFunctions[easingType];
        const easedProgress = easingFunction(rawScrollProgress * easingIntensity) / easingIntensity;
        const scrollProgress = Math.max(0, Math.min(1, easedProgress));
    ...
    }, [activeSection, getPositionConfig, getRotationConfig, getVideoSizeConfig, easingType, easingIntensity]);
    ...
    useEffect(() => {
        const setupScrollListener = async () => {
            ...
            console.log("Setting up Easing Demo scroll listener...");
            ...
            setTimeout(() => {
                ...
                console.log("Easing Demo scroll listener attached successfully");
            }, 100);
        };
    ...
    useEffect(() => {
        ...
        video.addEventListener("loadeddata", () => {
            console.log("Easing Demo video loaded successfully");
    ...
    return (
        <div className="demo-container">
            ...
            <div style={{
                ...
                <div>
                    <label>Intensity: {easingIntensity.toFixed(1)}</label>
                    <input
                        type="range"
                        min="0.1"
                        max="3.0"
