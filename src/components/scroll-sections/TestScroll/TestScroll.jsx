  ...
  return (
    <div ref={containerRef}>
      <section className="section one">
        <h2 className="section-title">Test Scroll Section 1</h2>
      ...
      <section className="section two">
        <h2 className="section-title">Test Scroll Section 2</h2>
        <p className="section-subtitle">Scroll once for 50% → Scroll again for 100% → Next section</p>
      ...
      <section className="section three">
        <h2 className="section-title">Test Scroll Section 3</h2>
        <p className="section-subtitle">Scroll once for 50% → Scroll again for 100% → Next section</p>
      ...
      <section className="section four">
        <h2 className="section-title">Test Scroll Section 4</h2>
        <p className="section-subtitle">Scroll once for 50% → Scroll again for 100% → Next section</p>
      ...
      <section className="section five">
        <h2 className="section-title">Test Scroll Section 5</h2>
        <p className="section-subtitle">Scroll once for 50% → Scroll again for 100% → Next section</p>
      ...
      <section className="section six">
        <h2 className="section-title">Test Scroll Section 6</h2>
        <p className="section-subtitle">Scroll once for 50% → Scroll again for 100% → Next section</p>
      ...
      <section className="section seven">
        <h2 className="section-title">Test Scroll Section 7</h2>
        <p className="section-subtitle">Scroll once for 50% → Scroll again for 100% → Next section</p>
      ...
      <section className="section eight">
        <h2 className="section-title">Test Scroll Section 8</h2>
        <p className="section-subtitle">Scroll once for 50% → Scroll again for 100% → Next section</p>
      ...
      <section className="section nine">
        <h2 className="section-title">Test Scroll Section 9</h2>
        <p className="section-subtitle">Scroll once for 50% → Scroll again for 100% → Next section</p>
      ...
      <section className="section last">
        <h2 className="section-title">Test Scroll Section 10</h2>
        <p className="section-subtitle">Scroll once for 50% → Scroll again for 100% → Next section</p>
